						...
						if (mysqli_num_rows($record) > 0) {						
							...
							while($row = mysqli_fetch_array($result)) {
								...
								<tr>
									...
									<td><?php echo number_format($row['nett'],2); ?></td>
        ...
        <form role="form" method="post" action="">
          <div class="modal-header">
			...
			<div class="row form-group">
					...
					<div class="col-sm-2">
						<input readonly type="text" step="any" class="form-control" name="no_bukti" id="" placeholder="#AUTOFILL" required>
					</div>

					<!-- <div class="col-sm-2">
	                <input type="text" step="any" class="form-control" name="no_bukti" id="" placeholder="#AUTOFILL" value=<?php echo $row["no_bukti"]; ?> required disabled>
	             	 </div> -->
